...
### from the 2023 APL Problem Solving Competition
...
<img style="max-width:45%;height:400px;float:right;" src="../img/bio.png" />
...
- takes a non-negative integer left argument, <strong>N</strong></li>
