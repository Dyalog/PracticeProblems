...
<pre class="language-APL" style="background: none; color: #000;">
                                        ┌───┐        
                                        │   │
                                        │   │
                                        │   │
...
Write an APL expression that given a right argument `Y` of any array and a numeric scalar or vector left argument `X` returns a Boolean indicating if the left argument is a valid argument for `X⍉Y`.
