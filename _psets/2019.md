...
💡 Hint: The mix [`↑`](http://help.dyalog.com/latest/Content/Language/Primitive%20Functions/Mix.htm) and rotate [`⌽`](http://help.dyalog.com/latest/Content/Language/Primitive%20Functions/Rotate.htm) functions will probably be useful here.
...
<desc>Reset to original origin</desc>
  ...
  </td><td style="border: none;" markdown="1">
...
💡 Hint: The rotate [`⌽`](http://help.dyalog.com/latest/Content/Language/Primitive%20Functions/Rotate.htm) and power [`*`](http://help.dyalog.com/latest/Content/Language/Primitive%20Functions/Power.htm) functions might be useful.
...
💡 Hint: You may want to investigate the rotate first [`⊖`](http://help.dyalog.com/latest/Content/Language/Primitive%20Functions/Rotate%20First.htm) function.
...
💡 Hint: You may want to look into the dyadic form of the key operator [`⌸`](http://help.dyalog.com/latest/Content/Language/Primitive%20Operators/Key.htm).
